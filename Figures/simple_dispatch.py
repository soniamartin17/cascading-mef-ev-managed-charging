...
class GridModel(object):
    ...
    def __init__(self, year=2020, gd=None, reference_year=2020, calculate_aef=True, co2_price = None, added_evs = True, time=1):
        ...
        self.bs = bidStack(self.gd, co2_dol_per_kg=self.co2_price, time=time, dropNucHydroGeo=True, include_min_output=False, mdt_weight=0.5, include_easiur=False)
